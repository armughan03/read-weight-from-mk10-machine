            ...
            while True:
                ...
                if raw_data:
                    ...
                    if len(parts) > 1:
                        ...
                        weight = parts[0].strip()[::-1]  # Reverse the string if necessary
                        
                        # Skip invalid readings ("None" or "-")
                        if weight in ["None", "-"]:
                            print(f"Skipping invalid reading: {weight}")
                            buffer = parts[-1]  # Keep the last incomplete part in the buffer
                            continue
                        ...
                        if stable_weight is None or stable_weight == weight:
                            ...
                            print(f"Discrepancy found, resetting stable weight...")
                            stable_weight = None
